...
from pywebfw.domain.models import MenuArea, Role
...
from pywebfw.web.pages.admin import (
    AdminHomePage,
    AdminLoginPage,
...
from pywebfw.web.pages.base import BasePage, PageContext
from pywebfw.web.pages.public import (
    AboutPage,
    ContactPage,
    DynamicContentPage,
    EditorialPolicyPage,
